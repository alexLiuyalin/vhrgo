...
import (
	"github.com/go-kratos/beer-shop/app/frontend/app/internal/conf"
	...
	cartv1 "github.com/go-kratos/beer-frontend/api/cart/service/v1"
	catalogv1 "github.com/go-kratos/beer-frontend/api/catalog/service/v1"
	userv1 "github.com/go-kratos/beer-frontend/api/core/service/v1"
	orderv1 "github.com/go-kratos/beer-frontend/api/order/service/v1"
	paymentv1 "github.com/go-kratos/beer-frontend/api/payment/service/v1"
...
func NewUserServiceClient(r registry.Discovery, tp *tracesdk.TracerProvider) userv1.UserClient {
	conn, err := grpc.DialInsecure(
		context.Background(),
		grpc.WithEndpoint("discovery:///beer.core.service"),
