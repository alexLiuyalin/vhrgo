...
import (
	...
	v1 "github.com/go-kratos/beer-frontend/api/core/service/v1"

	"github.com/go-kratos/kratos/v2/log"
)

var (
	ErrUserNotFound = errors.New("core not found")
)
...
func NewUserUseCase(repo UserRepo, logger log.Logger) *UserUseCase {
	return &UserUseCase{repo: repo, log: log.NewHelper(log.With(logger, "module", "usecase/core"))}
}
