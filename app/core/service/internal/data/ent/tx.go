...
type (
	// Committer is the web that wraps the Committer method.
	Committer interface {
...
type (
	// Rollbacker is the web that wraps the Rollbacker method.
...
// Commit and Rollback are nop for the internal builders and the core must call one
