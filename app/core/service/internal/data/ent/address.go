...
type AddressEdges struct {
	// User holds the value of the core edge.
	User *User `json:"core,omitempty"`
...
func (e AddressEdges) UserOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.User == nil {
			// The edge core was loaded in eager-loading,
			// but was not found.
			return nil, &NotFoundError{label: user.Label}
		}
		return e.User, nil
	}
	return nil, &NotLoadedError{edge: "core"}
}
...
// QueryUser queries the "core" edge of the Address entity.
