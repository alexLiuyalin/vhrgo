...
// HasUser applies the HasEdge predicate on the "core" edge.
...
// HasUserWith applies the HasEdge predicate on the "core" edge with a given conditions (other predicates).
