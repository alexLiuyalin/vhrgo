...
import (
	...
	"github.com/go-kratos/beer-shop/app/core/service/internal/data/ent/address"
	"github.com/go-kratos/beer-shop/app/core/service/internal/data/ent/card"
	"github.com/go-kratos/beer-shop/app/core/service/internal/data/ent/predicate"
...
// SetUserID sets the "core" edge to the User entity by id.
func (m *AddressMutation) SetUserID(id int64) {
	m.user = &id
}

// ClearUser clears the "core" edge to the User entity.
func (m *AddressMutation) ClearUser() {
	m.cleareduser = true
}

// UserCleared returns if the "core" edge to the User entity was cleared.
func (m *AddressMutation) UserCleared() bool {
	return m.cleareduser
}

// UserID returns the "core" edge ID in the mutation.
...
// UserIDs returns the "core" edge IDs in the mutation.
...
// ResetUser resets all changes to the "core" edge.
