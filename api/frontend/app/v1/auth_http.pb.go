...
const OperationAuthLogin = "/api.frontend.app.v1.Auth/Login"
const OperationAuthLogout = "/api.frontend.app.v1.Auth/Logout"
...
type AuthHTTPClient interface {
	...
	Logout(ctx context.Context, req *LogoutRequest, opts ...http.CallOption) (rsp *Reply, err error)
}
...
func (c *AuthHTTPClientImpl) Logout(ctx context.Context, in *LogoutRequest, opts ...http.CallOption) (*Reply, error) {
	var out Reply
