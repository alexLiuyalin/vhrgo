...
var file_v1_auth_proto_rawDesc = []byte{
	...
	0x13, 0x61, 0x70, 0x69, 0x2e, 0x66, 0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x61, 0x70,
	...
	0x61, 0x70, 0x69, 0x2e, 0x66, 0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64, 0x2e, 0x61, 0x70, 0x70,
	...
	0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x70, 0x6c,
	...
	0x74, 0x65, 0x6e, 0x64, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x67, 0x6f,
	...
	0x42, 0x18, 0x5a, 0x16, 0x61, 0x70, 0x69, 0x2f, 0x66, 0x72, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x64,
...
var file_v1_auth_proto_goTypes = []interface{}{
	(*LoginRequest)(nil),  // 0: api.frontend.app.v1.LoginRequest
	(*LoginReply)(nil),    // 1: api.frontend.app.v1.LoginReply
	(*Reply)(nil),         // 2: api.frontend.app.v1.Reply
	(*LogoutRequest)(nil), // 3: api.frontend.app.v1.LogoutRequest
}
var file_v1_auth_proto_depIdxs = []int32{
	0, // 0: api.frontend.app.v1.Auth.Login:input_type -> api.frontend.app.v1.LoginRequest
	3, // 1: api.frontend.app.v1.Auth.Logout:input_type -> api.frontend.app.v1.LogoutRequest
	1, // 2: api.frontend.app.v1.Auth.Login:output_type -> api.frontend.app.v1.LoginReply
	2, // 3: api.frontend.app.v1.Auth.Logout:output_type -> api.frontend.app.v1.Reply
